...
@endif
<form action="{{ route('movies.store') }}" method="POST" style="padding:20px 0;">
    @csrf
    <div>
    ...
    <div>
        ...
        <input type="number" id="published_year" name="published_year" value="{{ old('published_year', 2025) }}" required>年
    </div>
    <div>
